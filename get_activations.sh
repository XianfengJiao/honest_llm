# CUDA_VISIBLE_DEVICES=0 python get_activations.py llama_7B tqa_mc2 --device 0 
# CUDA_VISIBLE_DEVICES=0 python get_activations.py llama_7B tqa_gen_end_q --device 0 
...
CUDA_VISIBLE_DEVICES=1 python get_activations.py llama_7B tqa_mc2 --device 0
CUDA_VISIBLE_DEVICES=1 python get_activations.py llama_7B tqa_gen_end_q --device 0